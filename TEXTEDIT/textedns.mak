...
INCLUDE_DIRS=C:/DJGPP/CONTRIB/TVISION/INCLUDE
LIB_DIRS=
C_DEBUG_FLAGS=
C_OPT_FLAGS=
C_WARN_FLAGS=
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=aboutdlg.o aboutosp.o ospedit1.o ospedit2.o ospedit3.o sound.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= aboutdlg.o aboutosp.o ospedit1.o ospedit2.o ospedit3.o sound.o 
NO_LINK=
