...
INCLUDE_DIRS=$(DJDIR)/CONTRIB/TVISION/INCLUDE src src/convert
LIB_DIRS=
C_DEBUG_FLAGS=
C_OPT_FLAGS=
C_WARN_FLAGS=
...
LIBS=alleg rhtv
LD_EXTRA_FLAGS=-s
C_EXTRA_FLAGS=-s -fno-rtti -fno-exceptions
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=obj/djgppsnd/aboutdlg.o obj/djgppsnd/aboutosp.o\
	obj/djgppsnd/convert.o obj/djgppsnd/ospedit1.o\
	obj/djgppsnd/ospedit2.o obj/djgppsnd/ospedit3.o\
	obj/djgppsnd/sound.o obj/djgppsnd/verinfo.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
MAIN_TARGET=bin/djgppsnd/ospedit.exe
PROJECT_ITEMS=aboutdlg.cpp aboutosp.cpp convert.c ospedit1.cpp ospedit2.cpp\
	ospedit3.cpp sound.c verinfo.cpp
DEFAULT_MASK=*.[acfghimnops]*
RHIDE_BIN_DIR=$(DJDIR)/bin
PASCAL_TYPE=GPC
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= obj/djgppsnd/aboutdlg.o obj/djgppsnd/aboutosp.o\
	obj/djgppsnd/convert.o obj/djgppsnd/ospedit1.o\
	obj/djgppsnd/ospedit2.o obj/djgppsnd/ospedit3.o\
	obj/djgppsnd/sound.o obj/djgppsnd/verinfo.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
bin/djgppsnd/ospedit.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=aboutdlg.cpp
obj/djgppsnd/aboutdlg.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=aboutosp.cpp
obj/djgppsnd/aboutosp.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=convert.c
obj/djgppsnd/convert.o:: $(DEPS_3)
	$(RHIDE_COMPILE.c.o)
DEPS_4=ospedit1.cpp
obj/djgppsnd/ospedit1.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=ospedit2.cpp
obj/djgppsnd/ospedit2.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
DEPS_6=ospedit3.cpp
obj/djgppsnd/ospedit3.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cpp.o)
DEPS_7=sound.c
obj/djgppsnd/sound.o:: $(DEPS_7)
	$(RHIDE_COMPILE.c.o)
DEPS_8=verinfo.cpp
obj/djgppsnd/verinfo.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cpp.o)
all:: bin/djgppsnd/ospedit.exe
