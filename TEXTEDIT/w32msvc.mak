...
CFLAGS   = -D_BCPP /D__WIN32__ /D__MSVC__ $(CDEBUGFLAGS)
CXXFLAGS = $(CFLAGS)
LDFLAGS   = $(DYNRTLDFLAGS) /SUBSYSTEM:CONSOLE

.SUFFIXES: .cc .c .obj

OBJS_ =  +aboutdlg.obj +aboutosp.obj +convert.obj +ospedit1.obj +ospedit2.obj +ospedit3.obj\
            +sound.obj +verinfo.obj

OBJS_2 = obj\w32msvc\aboutdlg.obj obj\w32msvc\aboutosp.obj obj\w32msvc\convert.obj obj\w32msvc\ospedit1.obj\
            obj\w32msvc\ospedit2.obj obj\w32msvc\ospedit3.obj obj\w32msvc\sound.obj\
            obj\w32msvc\verinfo.obj
...
bin/w32msvc/ospedit.exe: $(OBJS) obj/w32msvc/ospedit.res
	$(LD) /OUT:bin\w32msvc\ospedit.exe $(LDFLAGS) $(OBJS_2) libtv.lib kernel32.lib user32.lib winmm.lib gdi32.lib obj\w32msvc\ospedit.res
